                    ...
                    case QD:
                        {
                            ...
                            c = e;
                            return (0, fi.getIn)(c, [r, n]) !== n && (c = Gg(c, n, a, r, i)),
                            Wa(c, r, s, o, i)
                        }
                    case $D:
                        {
                ...
                case _r:
                    {
                        let s = i(e, pt),
                            c = i(e, vt),
                            h, y;
                        return n.config.widthUnit === Ct ? h = gE.test(s) ? parseFloat(s) : parseFloat(r.width) : h = (0, xt.default)(parseFloat(s), parseFloat(r.width)),
                        n.config.heightUnit === Ct ? y = gE.test(c) ? parseFloat(c) : parseFloat(r.height) : y = (0, xt.default)(parseFloat(c), parseFloat(r.height)),
                        {
                            widthValue: h,
                            heightValue: y
                        }
                ...
                case _r:
                    {
                        ...
                        } = n.config,
                        {
                            widthValue: h,
                            heightValue: y
                        } = r;h !== void 0 && (s === Ct && (s = "px"), Bt(e, pt, i), a(e, pt, h + s)),
                        y !== void 0 && (c === Ct && (c = "px"), Bt(e, vt, i), a(e, vt, y + c));
                        break
                    }
                case nn:
                    {
                ...
                case gi:
                    {
                        let {
                            value: o
                        } = t.config;o === s1 && We.IS_BROWSER_ENV ? n(e, vi, We.FLEX_PREFIXED) : n(e, vi, o);
                        return
                    }
            }
        }
                            ...
                            case Ht.EventBasedOn.PAGE:
                                {
                                    let {
                                        ...
                                        scrollWidth: D,
                                        scrollHeight: B
                                    } = sn();R = w ? Math.min(M + _, D) / D : Math.min(q + m, B) / B;
                                    break
                                }
